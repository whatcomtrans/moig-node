...
module.exports = class oigACDPath extends EventEmitter {
    ...
    **/
    ...
    /**
     * Returns the call object represented by the CURRENT_GLOBAL_CALL_ID, returns undefined if not found
     * 
     * @param {String} CURRENT_GLOBAL_CALL_ID 
     * 
     * @memberOf oigACDPath
     */
    getCallByGlobalID(CURRENT_GLOBAL_CALL_ID) {
        var _this = this
        return _this._calls.find(function(element) {
            return element.CURRENT_GLOBAL_CALL_ID == CURRENT_GLOBAL_CALL_ID
        })
    }
    ...
    removeCall(callEvent, callback) {
        ...
        var i = _this._calls.findIndex(function(element) {
            return element.CURRENT_GLOBAL_CALL_ID == callEvent.CURRENT_GLOBAL_CALL_ID
        })
    ...
    updateCall(callEvent, callback) {
        ...
        } else if (callEvent.deleteMe){
            this.removeCall(callEvent, callback)
        } else {
            var c = {}
