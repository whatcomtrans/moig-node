...
class oigSessionClient extends EventEmitter {
    ...
    connect (options, callback) {
        ...
        if (options === undefined) {
            ...
            // Both parameters exists, treet as is
        }
    ...
    resetSessionTimer(client) {
        var _this = this
        if (arguments.length > 0) {
            var _this = client  // called by timeout, this returns the timeout, not the calling object so need calling object as parameter
        }
